...
namespace Marten.Generated.EventStore
{
    ...
    public sealed class AppendEventOperation : Marten.Events.Operations.AppendEventOperationBase
    {
        ...
        {
            builder.Append("insert into public.mt_events (data, type, mt_dotnet_type, id, stream_id, version, timestamp, tenant_id, correlation_id, causation_id, headers, seq_id) values (");
