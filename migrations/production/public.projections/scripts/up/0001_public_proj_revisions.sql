DROP FUNCTION IF EXISTS public.mt_upsert_publiekverenigingsequencedocument(doc jsonb, docdotnettype character varying, docid character varying, revision integer) cascade;

CREATE OR REPLACE FUNCTION public.mt_upsert_publiekverenigingsequencedocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
