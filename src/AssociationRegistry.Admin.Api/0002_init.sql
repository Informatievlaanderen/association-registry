...
DROP TABLE IF EXISTS public.mt_doc_addresskafkaconsumeroffset CASCADE;
...
CONSTRAINT pkey_mt_doc_addresskafkaconsumeroffset_id PRIMARY KEY (id)
);

CREATE OR REPLACE FUNCTION public.mt_upsert_addresskafkaconsumeroffset(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_insert_addresskafkaconsumeroffset(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_addresskafkaconsumeroffset ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, docVersion, transaction_timestamp());
...
CREATE OR REPLACE FUNCTION public.mt_update_addresskafkaconsumeroffset(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
DROP TABLE IF EXISTS public.mt_doc_beheerkbosynchistoriekgebeurtenisdocument CASCADE;
CREATE TABLE public.mt_doc_beheerkbosynchistoriekgebeurtenisdocument (
    ...
    mt_version          uuid                        NOT NULL DEFAULT (md5(random()::text || clock_timestamp()::text)::uuid),
    mt_dotnet_type      varchar                     NULL,
CONSTRAINT pkey_mt_doc_beheerkbosynchistoriekgebeurtenisdocument_id PRIMARY KEY (id)
);

CREATE OR REPLACE FUNCTION public.mt_upsert_beheerkbosynchistoriekgebeurtenisdocument(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_insert_beheerkbosynchistoriekgebeurtenisdocument(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_beheerkbosynchistoriekgebeurtenisdocument ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, docVersion, transaction_timestamp());
...
CREATE OR REPLACE FUNCTION public.mt_update_beheerkbosynchistoriekgebeurtenisdocument(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
DROP TABLE IF EXISTS public.mt_doc_beheerverenigingdetaildocument CASCADE;
...
CONSTRAINT pkey_mt_doc_beheerverenigingdetaildocument_id PRIMARY KEY (id)
);
...
CREATE OR REPLACE FUNCTION public.mt_upsert_beheerverenigingdetaildocument(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_insert_beheerverenigingdetaildocument(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_beheerverenigingdetaildocument ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, docVersion, transaction_timestamp());
...
CREATE OR REPLACE FUNCTION public.mt_update_beheerverenigingdetaildocument(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
DROP TABLE IF EXISTS public.mt_doc_beheervereniginghistoriekdocument CASCADE;
CREATE TABLE public.mt_doc_beheervereniginghistoriekdocument (
    ...
    mt_version          uuid                        NOT NULL DEFAULT (md5(random()::text || clock_timestamp()::text)::uuid),
    mt_dotnet_type      varchar                     NULL,
CONSTRAINT pkey_mt_doc_beheervereniginghistoriekdocument_id PRIMARY KEY (id)
);

CREATE OR REPLACE FUNCTION public.mt_upsert_beheervereniginghistoriekdocument(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_insert_beheervereniginghistoriekdocument(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_beheervereniginghistoriekdocument ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, docVersion, transaction_timestamp());
...
CREATE OR REPLACE FUNCTION public.mt_update_beheervereniginghistoriekdocument(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
DROP TABLE IF EXISTS public.mt_doc_locatielookupdocument CASCADE;
...
CONSTRAINT pkey_mt_doc_locatielookupdocument_id PRIMARY KEY (id)
);

CREATE OR REPLACE FUNCTION public.mt_upsert_locatielookupdocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION public.mt_insert_locatielookupdocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_locatielookupdocument ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, revision, transaction_timestamp());
  RETURN 1;
END;
...
CREATE OR REPLACE FUNCTION public.mt_update_locatielookupdocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version INTEGER;
  current_version INTEGER;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_overwrite_locatielookupdocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version INTEGER;
  current_version INTEGER;
BEGIN
...
DROP TABLE IF EXISTS public.mt_doc_locatiezonderadresmatchdocument CASCADE;
CREATE TABLE public.mt_doc_locatiezonderadresmatchdocument (
    ...
    mt_dotnet_type      varchar                     NULL,
    mt_version          integer                     NOT NULL DEFAULT 0,
CONSTRAINT pkey_mt_doc_locatiezonderadresmatchdocument_id PRIMARY KEY (id)
);
...
CREATE OR REPLACE FUNCTION public.mt_insert_locatiezonderadresmatchdocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_locatiezonderadresmatchdocument ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, revision, transaction_timestamp());
  RETURN 1;
END;
...
CREATE OR REPLACE FUNCTION public.mt_update_locatiezonderadresmatchdocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version INTEGER;
  current_version INTEGER;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_overwrite_locatiezonderadresmatchdocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version INTEGER;
  current_version INTEGER;
BEGIN
...
DROP TABLE IF EXISTS public.mt_doc_magdacallreference CASCADE;
CREATE TABLE public.mt_doc_magdacallreference (
    ...
    mt_version          uuid                        NOT NULL DEFAULT (md5(random()::text || clock_timestamp()::text)::uuid),
    mt_dotnet_type      varchar                     NULL,
CONSTRAINT pkey_mt_doc_magdacallreference_id PRIMARY KEY (id)
);

CREATE OR REPLACE FUNCTION public.mt_upsert_magdacallreference(doc JSONB, docDotNetType varchar, docId uuid, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_insert_magdacallreference(doc JSONB, docDotNetType varchar, docId uuid, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_magdacallreference ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, docVersion, transaction_timestamp());
...
CREATE OR REPLACE FUNCTION public.mt_update_magdacallreference(doc JSONB, docDotNetType varchar, docId uuid, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
DROP TABLE IF EXISTS public.mt_doc_postalnutslauinfo CASCADE;
CREATE TABLE public.mt_doc_postalnutslauinfo (
    ...
    mt_version          uuid                        NOT NULL DEFAULT (md5(random()::text || clock_timestamp()::text)::uuid),
    mt_dotnet_type      varchar                     NULL,
CONSTRAINT pkey_mt_doc_postalnutslauinfo_id PRIMARY KEY (id)
);

CREATE OR REPLACE FUNCTION public.mt_upsert_postalnutslauinfo(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_insert_postalnutslauinfo(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_postalnutslauinfo ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, docVersion, transaction_timestamp());
...
CREATE OR REPLACE FUNCTION public.mt_update_postalnutslauinfo(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
DROP TABLE IF EXISTS public.mt_doc_powerbiexportdocument CASCADE;
CREATE TABLE public.mt_doc_powerbiexportdocument (
    ...
    mt_dotnet_type      varchar                     NULL,
    mt_version          integer                     NOT NULL DEFAULT 0,
CONSTRAINT pkey_mt_doc_powerbiexportdocument_id PRIMARY KEY (id)
);
...
CREATE OR REPLACE FUNCTION public.mt_insert_powerbiexportdocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_powerbiexportdocument ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, revision, transaction_timestamp());
  RETURN 1;
END;
...
CREATE OR REPLACE FUNCTION public.mt_update_powerbiexportdocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version INTEGER;
  current_version INTEGER;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_overwrite_powerbiexportdocument(doc JSONB, docDotNetType varchar, docId varchar, revision integer) RETURNS INTEGER LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version INTEGER;
  current_version INTEGER;
BEGIN
...
DROP TABLE IF EXISTS public.mt_doc_settingoverride CASCADE;
CREATE TABLE public.mt_doc_settingoverride (
    ...
    mt_version          uuid                        NOT NULL DEFAULT (md5(random()::text || clock_timestamp()::text)::uuid),
    mt_dotnet_type      varchar                     NULL,
CONSTRAINT pkey_mt_doc_settingoverride_id PRIMARY KEY (id)
);

CREATE OR REPLACE FUNCTION public.mt_upsert_settingoverride(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_insert_settingoverride(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_settingoverride ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, docVersion, transaction_timestamp());
...
CREATE OR REPLACE FUNCTION public.mt_update_settingoverride(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
DROP TABLE IF EXISTS public.mt_doc_verenigingstate CASCADE;
CREATE TABLE public.mt_doc_verenigingstate (
    ...
    mt_version          uuid                        NOT NULL DEFAULT (md5(random()::text || clock_timestamp()::text)::uuid),
    mt_dotnet_type      varchar                     NULL,
CONSTRAINT pkey_mt_doc_verenigingstate_id PRIMARY KEY (id)
);

CREATE OR REPLACE FUNCTION public.mt_upsert_verenigingstate(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
...
CREATE OR REPLACE FUNCTION public.mt_insert_verenigingstate(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
BEGIN
INSERT INTO public.mt_doc_verenigingstate ("data", "mt_dotnet_type", "id", "mt_version", mt_last_modified) VALUES (doc, docDotNetType, docId, docVersion, transaction_timestamp());
...
CREATE OR REPLACE FUNCTION public.mt_update_verenigingstate(doc JSONB, docDotNetType varchar, docId varchar, docVersion uuid) RETURNS UUID LANGUAGE plpgsql SECURITY INVOKER AS $function$
DECLARE
  final_version uuid;
BEGIN
