        ...
        var searchRequest = new SearchRequest<DuplicateDetectionDocument>(_elasticSearchOptionsSection.Indices!.DuplicateDetection!)
        {
            ...
            Query = new BoolQuery
            {
                ...
                Filter = new List<Query>
                {
                    ...
                    new TermQuery { Field = "isDubbel", Value = false },
                    new TermQuery { Field = "isGestopt", Value = false },
                    new TermQuery { Field = "isVerwijderd", Value = false }
                },
