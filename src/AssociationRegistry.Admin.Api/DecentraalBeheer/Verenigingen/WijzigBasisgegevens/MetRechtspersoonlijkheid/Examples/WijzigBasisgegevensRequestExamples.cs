namespace AssociationRegistry.Admin.Api.DecentraalBeheer.Verenigingen.WijzigBasisgegevens.MetRechtspersoonlijkheid.Examples;
...
public class WijzigBasisgegevensRequestExamples : IExamplesProvider<WijzigBasisgegevensRequest>
{
    public WijzigBasisgegevensRequest GetExamples()
        => new()
        {
            ...
            Werkingsgebieden = Werkingsgebied.All.Skip(10).Take(5).Select(h => h.Code).ToArray(),
        };
}
