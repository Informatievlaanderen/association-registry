...
public class Program
{
    ...
    private static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        builder.Services
               ...
               .AddScoped<IVertegenwoordigerPersoonsgegevensService, VertegenwoordigerPersoonsgegevensService>()
               ...
               .AddScoped<IMagdaCallReferenceRepository, MagdaCallReferenceRepository>()
