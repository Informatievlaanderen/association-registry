namespace AssociationRegistry.Admin.Api.WebApi.Verenigingen.Registreer.VerenigingZonderEigenRechtspersoonlijkheid;
...
public class RegistreerVerenigingZonderEigenRechtspersoonlijkheidController : ApiController
{
    ...
    [SwaggerRequestExample(
        typeof(RegistreerVerenigingZonderEigenRechtspersoonlijkheidRequest),
        typeof(RegistreerVerenigingZonderEigenRechtspersoonlijkheidRequestExamples)
    )]
