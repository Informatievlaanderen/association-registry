namespace AssociationRegistry.Admin.Api.WebApi.Verenigingen.Vertegenwoordigers.VerenigingOfAnyKind.WijzigVertegenwoordiger;
...
public class WijzigVertegenwoordigerController : ApiController
{
    ...
    [HttpPatch("{vCode}/vertegenwoordigers/{vertegenwoordigerId:int}")]
    [ConsumesJson]
    [ProducesJson]
