...
public class BeheerVerenigingDetailProjection : EventProjection
{
    ...
    public BeheerVerenigingDetailDocument Create(IEvent<FeitelijkeVerenigingMetPersoonsgegevensGeregistreerd> @event, IDocumentOperations ops)
    ...
    public async Task Project(IEvent<VertegenwoordigerWerdVerwijderdMetPersoonsgegevens> @event, IDocumentOperations ops)
        => await Update(@event, ops, BeheerVerenigingDetailProjector.Apply);
