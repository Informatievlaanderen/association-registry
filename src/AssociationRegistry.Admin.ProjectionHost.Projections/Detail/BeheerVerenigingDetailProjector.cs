...
public class BeheerVerenigingDetailProjector
{
    ...
    public static BeheerVerenigingDetailDocument Create(
        ...
        new()
        {
            ...
            Metadata = new Metadata(
                verenigingMetRechtspersoonlijkheidWerdGeregistreerd.Sequence,
    ...
    )
    {
        ...
        var vertegenwoordiger = new Vertegenwoordiger
        {
            ...
            VertegenwoordigerId = dataVertegenwoordigerId,
            Insz = dataInsz,
    ...
    public static void Apply(IEvent<ErkenningWerdVerlengd> @event, BeheerVerenigingDetailDocument document)
    {
        document.Erkenningen = document
            .Erkenningen.UpdateSingle(
                identityFunc: b => b.ErkenningId == @event.Data.ErkenningId,
