...
{
    public static readonly ShardName ShardName = new("beheer.elastic.duplicatedetection");

    public DuplicateDetectionProjectionHandler() { }

    public void Handle(
        EventEnvelope<FeitelijkeVerenigingWerdGeregistreerd> message,
    ...
    {
        document.Locaties = document.Locaties.Append(Map(message.Data.Locatie)).OrderBy(x => x.LocatieId).ToArray();
    }
    ...
    public void Handle(
        EventEnvelope<MaatschappelijkeZetelWerdGewijzigdInKbo> message,
        DuplicateDetectionDocument document
    )
    {
        document.Locaties = document
    ...
    public void Handle(
        EventEnvelope<AdresWerdOvergenomenUitAdressenregister> message,
        DuplicateDetectionDocument document
    )
    {
