...
public class AdminInstrumentation : IInstrumentation, IDisposable
{
    ...
    public AdminInstrumentation()
    {
        ...
        _verenigingZoeken = meter.CreateObservableGauge(name: "ar.beheer.p.zoeken.g", unit: "events",
                                                        description: "Beheer zoeken projection",
                                                        observeValue: () => VerenigingZoekenEventValue);

        _verenigingDetail = meter.CreateObservableGauge(name: "ar.beheer.p.detail.g", unit: "events",
