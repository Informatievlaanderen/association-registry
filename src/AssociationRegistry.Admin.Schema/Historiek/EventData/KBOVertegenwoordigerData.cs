...
) : IVertegenwoordigerData<KBOVertegenwoordigerData>
{
    public static KBOVertegenwoordigerData Create(VertegenwoordigerWerdOvergenomenUitKBO vertegenwoordiger) =>
        new(vertegenwoordiger.VertegenwoordigerId, vertegenwoordiger.Voornaam, vertegenwoordiger.Achternaam);
    ...
    public KBOVertegenwoordigerData MakeAnonymous() =>
        this with
        {
