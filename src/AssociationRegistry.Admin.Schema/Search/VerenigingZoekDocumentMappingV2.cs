...
public static class VerenigingZoekDocumentMappingV2
{
    ...
    public static TypeMappingDescriptor<VerenigingZoekDocumentV2> Get(TypeMappingDescriptor<VerenigingZoekDocumentV2> map)
        => map.Properties(
