...
public class VerwijderVertegenwoordigerCommandHandler
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await _outbox.SendAsync(new CommandEnvelope<StartBewaartermijnMessage>(new StartBewaartermijnMessage(message.Command.VCode, message.Command.VertegenwoordigerId, "VertegenwoordigerWerdVerwijderd"), message.Metadata));
