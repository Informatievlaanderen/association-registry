...
public class FeitelijkeVerenigingWerdGeregistreerdUpcaster
{
    ...
    )
    {
        ...
        var refIdsFromFeitelijkeVereniging = feitelijkeVerenigingWerdGeregistreerdZonderPersoonsgegevens
        ...
        var vertegenwoordigers = feitelijkeVerenigingWerdGeregistreerdZonderPersoonsgegevens
