...
public class KszSyncHeeftVertegenwoordigerAangeduidAlsNietGekendUpcaster
{
    private readonly Func<IQuerySession> _querySessionFunc;

    public KszSyncHeeftVertegenwoordigerAangeduidAlsNietGekendUpcaster(Func<IQuerySession> querySessionFunc)
    {
