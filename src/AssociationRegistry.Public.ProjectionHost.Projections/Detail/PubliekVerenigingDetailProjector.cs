...
{
    public static PubliekVerenigingDetailDocument Create(IEvent<FeitelijkeVerenigingWerdGeregistreerd> @event) =>
    ...
    private static PubliekVerenigingDetailDocument CreateVerenigingZonderEigenRechtspersoonlijkheidDocument(
        IEvent<IVerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd> @event
    )
    {
        return new()
        {
            ...
            Doelgroep = MapDoelgroep(@event.Data.Doelgroep, @event.Data.VCode),
            DatumLaatsteAanpassing = @event.GetHeaderInstant(MetadataHeaderNames.Tijdstip).FormatAsBelgianDate(),
            Status = VerenigingStatus.Actief,
            Contactgegevens = @event
                .Data.Contactgegevens.Select(c => new PubliekVerenigingDetailDocument.Types.Contactgegeven
                {
                    JsonLdMetadata = new JsonLdMetadata(
                        JsonLdType.Contactgegeven.CreateWithIdValues(@event.Data.VCode, c.ContactgegevenId.ToString()),
                ...
                .ToArray(),
            Locaties = @event.Data.Locaties.Select(loc => MapLocatie(@event.Data.VCode, loc)).ToArray(),
            HoofdactiviteitenVerenigingsloket = @event
                .Data.HoofdactiviteitenVerenigingsloket.Select(MapHoofdactiviteit)
                .ToArray(),
            ...
            [
                ...
                {
                    JsonLdMetadata = new JsonLdMetadata(
                        JsonLdType.Sleutel.CreateWithIdValues(@event.Data.VCode, Sleutelbron.VR.Waarde),
                        JsonLdType.Sleutel.Type
                    ),
                    Bron = Sleutelbron.VR.Waarde,
                    GestructureerdeIdentificator =
                        new PubliekVerenigingDetailDocument.Types.GestructureerdeIdentificator
                        {
                            JsonLdMetadata = new JsonLdMetadata(
    ...
    private static PubliekVerenigingDetailDocument.Types.Verenigingstype MapVerenigingstype(
        IVerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd data
    )
    {
        return data switch
        {
            FeitelijkeVerenigingWerdGeregistreerd => new PubliekVerenigingDetailDocument.Types.Verenigingstype
            {
                Code = Verenigingstype.FeitelijkeVereniging.Code,
                Naam = Verenigingstype.FeitelijkeVereniging.Naam,
            },
            VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd =>
                new PubliekVerenigingDetailDocument.Types.Verenigingstype
                {
    ...
    private static PubliekVerenigingDetailDocument.Types.Verenigingssubtype? MapVerenigingssubtype(
        IVerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd data
    )
    {
        return data switch
        {
            ...
            VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd =>
                new PubliekVerenigingDetailDocument.Types.Verenigingssubtype()
                {
                    Code = string.Empty,
                    Naam = string.Empty,
                },
    ...
    public static PubliekVerenigingDetailDocument Create(
        ...
        new()
        {
            ...
            {
                JsonLdMetadata = new JsonLdMetadata(
                    JsonLdType.Doelgroep.CreateWithIdValues(
            ...
            [
                ...
                {
                    JsonLdMetadata = new JsonLdMetadata(
                        JsonLdType.Sleutel.CreateWithIdValues(
                            verenigingMetRechtspersoonlijkheidWerdGeregistreerd.Data.VCode,
                            Sleutelbron.VR.Waarde
                        ),
                        JsonLdType.Sleutel.Type
    ...
    public static void Apply(
        IEvent<RoepnaamWerdGewijzigd> roepnaamWerdGewijzigd,
    ...
    public static void Apply(
        IEvent<StartdatumWerdGewijzigd> startdatumWerdGewijzigd,
        PubliekVerenigingDetailDocument document
    )
    {
    ...
    public static void Apply(
        IEvent<StartdatumWerdGewijzigdInKbo> startdatumWerdGewijzigdInKbo,
        PubliekVerenigingDetailDocument document
    )
    {
    ...
    public static void Apply(
        IEvent<KorteNaamWerdGewijzigd> korteNaamWerdGewijzigd,
        PubliekVerenigingDetailDocument document
    )
    {
    ...
    public static void Apply(
        IEvent<DoelgroepWerdGewijzigd> doelgroepWerdGewijzigd,
        PubliekVerenigingDetailDocument document
    )
    {
    ...
    public static void Apply(
        IEvent<ContactgegevenWerdToegevoegd> contactgegevenWerdToegevoegd,
        PubliekVerenigingDetailDocument document
    )
    {
    ...
    )
    {
        document.Contactgegevens = document
            .Contactgegevens.Where(c => c.ContactgegevenId != contactgegevenWerdGewijzigd.Data.ContactgegevenId)
            .Append(
                new PubliekVerenigingDetailDocument.Types.Contactgegeven
                {
                    JsonLdMetadata = new JsonLdMetadata(
    ...
    public static void Apply(
        IEvent<ContactgegevenWerdVerwijderd> contactgegevenWerdVerwijderd,
        PubliekVerenigingDetailDocument document
    )
    {
        document.Contactgegevens = document
    ...
    public static void Apply(
        IEvent<LocatieWerdToegevoegd> locatieWerdToegevoegd,
        PubliekVerenigingDetailDocument document
    )
    {
        document.Locaties = Enumerable
            .Append(document.Locaties, MapLocatie(document.VCode, locatieWerdToegevoegd.Data.Locatie))
            .OrderBy(l => l.LocatieId)
            .ToArray();
    }

    public static void Apply(
        IEvent<LocatieWerdGewijzigd> locatieWerdGewijzigd,
        PubliekVerenigingDetailDocument document
    )
    {
        document.Locaties = document
            .Locaties.Where(l => l.LocatieId != locatieWerdGewijzigd.Data.Locatie.LocatieId)
    ...
    public static void Apply(
        IEvent<LocatieWerdVerwijderd> locatieWerdVerwijderd,
        PubliekVerenigingDetailDocument document
    )
    {
        document.Locaties = document
    ...
    {
        document.HoofdactiviteitenVerenigingsloket = hoofactiviteitenVerenigingloketWerdenGewijzigd
    ...
    )
    {
        document.Werkingsgebieden = werkingsgebiedenWerdenBepaald
            .Data.Werkingsgebieden.Select(h => new PubliekVerenigingDetailDocument.Types.Werkingsgebied
            {
                JsonLdMetadata = new JsonLdMetadata(
    ...
    {
        document.Locaties = document
            .Locaties.Where(l => l.LocatieId != maatschappelijkeZetelWerdGewijzigdInKbo.Data.Locatie.LocatieId)
    ...
    {
        var maatschappelijkeZetel = document.Locaties.Single(l =>
        ...
        document.Locaties = document
            .Locaties.Where(l => l.LocatieId != maatschappelijkeZetelVolgensKboWerdGewijzigd.Data.LocatieId)
    ...
    {
        var contactgegeven = document.Contactgegevens.Single(c =>
        ...
        document.Contactgegevens = document
            .Contactgegevens.Where(c => c.ContactgegevenId != contactgegevenUitKboWerdGewijzigd.Data.ContactgegevenId)
    ...
    public static void Apply(
        IEvent<VerenigingWerdGestoptInKBO> verenigingWerdGestoptInKbo,
        PubliekVerenigingDetailDocument document
    )
    {
        document.Status = VerenigingStatus.Gestopt;
    ...
    public static void Apply(
        IEvent<KBOStatusWerdGecorrigeerdNaarActief> verenigingWerdGestoptInKbo,
        PubliekVerenigingDetailDocument document
    )
    {
    ...
    public static void Apply(
        IEvent<KorteNaamWerdGewijzigdInKbo> korteNaamWerdGewijzigdInKbo,
        PubliekVerenigingDetailDocument document
    )
    {
    ...
    )
    {
        ...
        document.Contactgegevens = document
            .Contactgegevens.Where(c => c.ContactgegevenId != contactgegevenWerdGewijzigdUitKbo.Data.ContactgegevenId)
            .Append(contactgegeven)
            .OrderBy(l => l.ContactgegevenId)
            .ToArray();
    }
    ...
    )
    {
        ...
        document.Locaties = document
            .Locaties.Where(l => l.LocatieId != adresWerdOvergenomenUitAdressenregister.Data.LocatieId)
            .Append(
                locatie with
                {
                    JsonLdMetadata = new JsonLdMetadata(
                        JsonLdType.Locatie.CreateWithIdValues(
                            adresWerdOvergenomenUitAdressenregister.Data.VCode,
                            adresWerdOvergenomenUitAdressenregister.Data.LocatieId.ToString()
                        ),
                    ...
                    VerwijstNaar = MapVerwijstNaar(adresWerdOvergenomenUitAdressenregister.Data.AdresId),
                }
            )
            .OrderBy(l => l.LocatieId)
            .ToArray();
    ...
    )
    {
        ...
        document.Locaties = document
            .Locaties.Where(l => l.LocatieId != adresWerdGewijzigdInAdressenregister.Data.LocatieId)
            .Append(
                locatie with
                {
                    JsonLdMetadata = new JsonLdMetadata(
                        JsonLdType.Locatie.CreateWithIdValues(
                            adresWerdGewijzigdInAdressenregister.Data.VCode,
                            adresWerdGewijzigdInAdressenregister.Data.LocatieId.ToString()
                        ),
                        JsonLdType.Locatie.Type
                    ),
                    Adres = Map(
                    ...
                    VerwijstNaar = MapVerwijstNaar(adresWerdGewijzigdInAdressenregister.Data.AdresId),
                }
            )
            .OrderBy(l => l.LocatieId)
            .ToArray();
    ...
    )
    {
        ...
        document.Locaties = document
            .Locaties.Where(l => l.LocatieId != adresWerdNietGevondenInAdressenregister.Data.LocatieId)
            .Append(locatie with { AdresId = null, VerwijstNaar = null })
            .OrderBy(l => l.LocatieId)
            .ToArray();
    }
    ...
    )
    {
        ...
        document.Locaties = document
            .Locaties.Where(l => l.LocatieId != adresNietUniekInAdressenregister.Data.LocatieId)
            .Append(locatie with { AdresId = null, VerwijstNaar = null })
            .OrderBy(l => l.LocatieId)
            .ToArray();
    }
    ...
    )
    {
        ...
        document.Locaties = document
            .Locaties.Where(l => l.LocatieId != adresWerdOntkoppeldVanAdressenregister.Data.LocatieId)
            .Append(locatie with { AdresId = null, VerwijstNaar = null })
            .OrderBy(l => l.LocatieId)
            .ToArray();
    }

    private static PubliekVerenigingDetailDocument.Types.Locatie MapLocatie(
        string vCode,
        Registratiedata.Locatie loc
    ) =>
        new()
        {
            JsonLdMetadata = new JsonLdMetadata(
    ...
    private static PubliekVerenigingDetailDocument.Types.Locatie.AdresVerwijzing? MapVerwijstNaar(
    ...
    private static PubliekVerenigingDetailDocument.Types.AdresId? Map(string broncode, string bronwaarde) =>
        string.IsNullOrEmpty(bronwaarde)
            ? null
            : new PubliekVerenigingDetailDocument.Types.AdresId { Bronwaarde = bronwaarde, Broncode = broncode };
    ...
    {
        document.Locaties = document
            .Locaties.Where(l => l.LocatieId != locatieWerdVerwijderd.Data.VerwijderdeLocatieId)
            .OrderBy(l => l.LocatieId)
            .ToArray();
    }

    public static void Apply(
        IEvent<LidmaatschapWerdToegevoegd> lidmaatschapWerdToegevoegd,
        PubliekVerenigingDetailDocument document
    )
    {
    ...
    private static PubliekVerenigingDetailDocument.Types.Lidmaatschap MapLidmaatschap(
    ...
    public static void Apply(
        IEvent<LidmaatschapWerdGewijzigd> lidmaatschapWerdGewijzigd,
        PubliekVerenigingDetailDocument document
    )
    {
        document.Lidmaatschappen = document
            .Lidmaatschappen.Where(l => l.LidmaatschapId != lidmaatschapWerdGewijzigd.Data.Lidmaatschap.LidmaatschapId)
    ...
    public static void Apply(
        IEvent<LidmaatschapWerdVerwijderd> lidmaatschapWerdVerwijderd,
        PubliekVerenigingDetailDocument document
    )
    {
        document.Lidmaatschappen = document
    ...
    public static void Apply(
        IEvent<SubverenigingDetailsWerdenGewijzigd> @event,
        PubliekVerenigingDetailDocument document
    )
    {
        document.SubverenigingVan = document.SubverenigingVan! with
    ...
    public static void Apply(IEvent<ErkenningWerdGeactiveerd> @event, PubliekVerenigingDetailDocument document)
    {
        var erkenning = document.Erkenningen.Single(c => c.ErkenningId == @event.Data.ErkenningId);
        document.Erkenningen = document
            .Erkenningen.Where(c => c.ErkenningId != @event.Data.ErkenningId)
            .Append(erkenning with { Status = ErkenningStatus.Actief.Value })
            .OrderBy(c => c.ErkenningId)
            .ToArray();
    }
