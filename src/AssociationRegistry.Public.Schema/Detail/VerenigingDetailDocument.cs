...
public class PubliekVerenigingDetailDocument : IVCode, ISoftDeleted, ICanBeUitgeschrevenUitPubliekeDatastroom
{
    ...
    public Types.Contactgegeven[] Contactgegevens { get; set; } = [];
    public Types.HoofdactiviteitVerenigingsloket[] HoofdactiviteitenVerenigingsloket { get; set; } = [];
    public Types.Werkingsgebied[] Werkingsgebieden { get; set; } = [];
