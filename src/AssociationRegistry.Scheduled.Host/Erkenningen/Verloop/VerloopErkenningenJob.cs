...
public class VerloopErkenningenJob(IVerloopErkenningenProcessor processor, ILogger<VerloopErkenningenJob> logger) : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        {
            logger.LogError(ex, "Automatisch verloop van erkenningen kon niet voltooid worden. {Message}", ex.Message);
