...
public class WijzigVertegenwoordigerCommandHandler
{
    ...
    public async Task<CommandResult> Handle(CommandEnvelope<WijzigVertegenwoordigerCommand> envelope)
    {
        ...
        var (veretegenwoordigerId, rol, roepnaam, email, telefoonNummer, mobiel, socialMedia, isPrimair) = envelope.Command.Vertegenwoordiger;
        vereniging.WijzigVertegenwoordiger(veretegenwoordigerId, rol, roepnaam, email, telefoonNummer, mobiel, socialMedia, isPrimair);
