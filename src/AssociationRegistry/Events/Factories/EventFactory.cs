...
public static class EventFactory
{
    ...
    public static AdresWerdNietGevondenInAdressenregister AdresWerdNietGevondenInAdressenregister(
        VCode vCode,
        Locatie locatie
    ) =>
        new(
    ...
    public static MaatschappelijkeZetelWerdVerwijderdUitKbo MaatschappelijkeZetelWerdVerwijderdUitKbo(
        Locatie locatie
    ) => new(Locatie(locatie));
    ...
    public static Registratiedata.Locatie Locatie(Locatie locatie) =>
        new(
            ...
            locatie.AdresId is not null
                ? new Registratiedata.AdresId(locatie.AdresId.Adresbron.Code, locatie.AdresId.Bronwaarde)
                : null
        );
    ...
    public static WerkingsgebiedenWerdenNietVanToepassing WerkingsgebiedenWerdenNietVanToepassing(VCode vCode) =>
        new(vCode);

    public static VertegenwoordigerWerdVerwijderd VertegenwoordigerWerdVerwijderd(
    ...
    public static VertegenwoordigerWerdToegevoegdVanuitKBO VertegenwoordigerWerdToegevoegdVanuitKbo(
        Vertegenwoordiger vertegenwoordiger
    ) =>
        new(
            vertegenwoordiger.VertegenwoordigerId,
    ...
    public static VertegenwoordigerWerdGewijzigdInKBO VertegenwoordigerWerdGewijzigdInKBO(
        Vertegenwoordiger vertegenwoordiger
    ) =>
        new(
            vertegenwoordiger.VertegenwoordigerId,
    ...
    public static VertegenwoordigerWerdVerwijderdUitKBO VertegenwoordigerWerdVerwijderdUitKBO(
        Vertegenwoordiger vertegenwoordiger
    ) =>
        new(
            vertegenwoordiger.VertegenwoordigerId,
    ...
    ) => new(vCode, werkingsgebieden.Select(Werkingsgebied).ToArray());

    public static WerkingsgebiedenWerdenGewijzigd WerkingsgebiedenWerdenGewijzigd(
        VCode vCode,
        IEnumerable<Werkingsgebied> werkingsgebieden
    ) => new(vCode, werkingsgebieden.Select(Werkingsgebied).ToArray());

    public static VertegenwoordigerWerdToegevoegd VertegenwoordigerWerdToegevoegd(
        Vertegenwoordiger vertegenwoordiger
    ) =>
        new(
            vertegenwoordiger.VertegenwoordigerId,
    ...
    public static Registratiedata.AdresId? AdresId(AdresId? adresId)
    {
        ...
        return new Registratiedata.AdresId(adresId.Adresbron.Code, adresId.Bronwaarde);
    }
    ...
    public static MaatschappelijkeZetelWerdOvergenomenUitKbo MaatschappelijkeZetelWerdOvergenomenUitKbo(
        Locatie locatie
    ) => new(Locatie(locatie));
    ...
    public static MaatschappelijkeZetelVolgensKBOWerdGewijzigd MaatschappelijkeZetelVolgensKBOWerdGewijzigd(
        Locatie locatie
    ...
    public static NietUniekeAdresMatchUitAdressenregister NietUniekeAdresMatchUitAdressenregister(
        AddressMatchResponse response
    ) =>
        new()
        {
    ...
    public static DoelgroepWerdGewijzigd DoelgroepWerdGewijzigd(Doelgroep doelgroep) => new(Doelgroep(doelgroep));
    ...
    ) => new(hoofdactiviteitenVerenigingsloket.Select(HoofdactiviteitVerenigingsloket).ToArray());

    public static EinddatumWerdGewijzigd EinddatumWerdGewijzigd(Datum datum) => new(datum.Value);
    ...
    public static ContactgegevenWerdVerwijderdUitKBO ContactgegevenWerdVerwijderdUitKBO(
        Contactgegeven contactgegeven
    ) =>
        new(
            contactgegeven.ContactgegevenId,
    ...
    public static VerenigingssubtypeWerdVerfijndNaarFeitelijkeVereniging SubtypeWerdVerfijndNaarFeitelijkeVereniging(
        VCode vCode
    ) => new(vCode);
    ...
    public static VerenigingssubtypeWerdVerfijndNaarSubvereniging VerenigingssubtypeWerdVerfijndNaarSubvereniging(
        ...
        new(
            vCode,
            new Registratiedata.SubverenigingVan(andereVereniging, andereVerenigingNaam, identificatie, beschrijving)
        );
    ...
    public static BankrekeningnummerWerdToegevoegdVanuitKBO BankrekeningnummerWerdToegevoegdVanuitKBO(
        Bankrekeningnummer bankrekeningnummer
    ) => new(bankrekeningnummer.BankrekeningnummerId, bankrekeningnummer.Iban.Value);

    public static BankrekeningnummerWerdVerwijderdUitKBO BankrekeningnummerWerdVerwijderdUitKBO(
        Bankrekeningnummer bankrekeningnummer
    ) => new(bankrekeningnummer.BankrekeningnummerId, bankrekeningnummer.Iban.Value);
    ...
    private static Registratiedata.DuplicateVerenigingLocatie Locatie(DuplicaatVereniging.Types.Locatie locatie) =>
        new(locatie.Locatietype, locatie.IsPrimair, locatie.Adres, locatie.Naam, locatie.Postcode, locatie.Gemeente);

    private static Registratiedata.Verenigingstype Verenigingstype(
        DuplicaatVereniging.Types.Verenigingstype verenigingstype
    ) => new(verenigingstype.Code, verenigingstype.Naam);

    private static Registratiedata.Verenigingssubtype? Verenigingssubtype(
