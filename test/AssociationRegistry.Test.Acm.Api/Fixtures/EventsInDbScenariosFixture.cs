...
public class EventsInDbScenariosFixture : AcmApiFixture
{
    ...
    protected override async Task Given()
    {
        ...
        await AddEvents(
            AlleBasisGegevensWerdenGewijzigdEventsInDbScenario.VCode,
            AlleBasisGegevensWerdenGewijzigdEventsInDbScenario.GetSecondBatchOfEvents(),
            AlleBasisGegevensWerdenGewijzigdEventsInDbScenario.GetCommandMetadata());
    }
}
