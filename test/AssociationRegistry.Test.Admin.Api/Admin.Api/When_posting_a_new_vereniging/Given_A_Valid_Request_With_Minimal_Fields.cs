namespace AssociationRegistry.Test.Admin.Api.Admin.Api.When_posting_a_new_vereniging;
...
public class Given_A_Valid_Request_With_Minimal_Fields : IClassFixture<Given_A_Valid_Request_With_Minimal_Fields_Fixture>
{
    ...
    public async Task Then_it_returns_a_location_header()
    {
        ...
        response.Headers.Location!.OriginalString.Should().StartWith("http://localhost:11004/v1/verenigingen/V");
    }
