    ...
    public void Map_StatusNull_ReturnsAllVertegenwoordigersFlattened()
    {
        var docs = new[]
        {
            new VertegenwoordigersPerVCodeDocument
            {
                ...
                {
                    new VertegenwoordigerData(1, VertegenwoordigerKszStatus.Created),
        ...
        Assert.Contains(result, r => r.VCode == "V001" && r.VertegenwoordigerId == 1 && r.Status == VertegenwoordigerKszStatus.Created);
        ...
        var docs = new[]
        {
            new VertegenwoordigersPerVCodeDocument
            {
                ...
                VertegenwoordigersData = new[]
                {
                    ...
                    new VertegenwoordigerData(2, VertegenwoordigerKszStatus.Created),
                }
            },
            new VertegenwoordigersPerVCodeDocument
            {
