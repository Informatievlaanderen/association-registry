...
[UnitTest]
public class With_Werkingsgebieden_NVT
{
    private readonly VerenigingRepositoryMock _verenigingRepositoryMock;
    private readonly FeitelijkeVerenigingWerdGeregistreerdScenario _scenario;

    public With_Werkingsgebieden_NVT()
    {
        ...
        var command = new WijzigBasisgegevensCommand(_scenario.VCode, Werkingsgebieden: Werkingsgebieden.NietVanToepassing);
