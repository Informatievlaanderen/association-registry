...
public sealed class RegistreerVerenigingZonderEigenRechtspersoonlijkheid_WithAllFields
{
    private static RegistreerVerenigingZonderEigenRechtspersoonlijkheid_WithAllFields? called;
    public readonly RegistreerVerenigingZonderEigenRechtspersoonlijkheidRequest Request;
    public readonly HttpResponseMessage Response;

    private RegistreerVerenigingZonderEigenRechtspersoonlijkheid_WithAllFields(AdminApiFixture fixture)
    {
        ...
        Response ??= fixture.DefaultClient.RegistreerVerenigingZonderEigenRechtspersoonlijkheid(GetJsonBody(Request)).GetAwaiter().GetResult();

        using var session = fixture.DocumentStore.LightweightSession();
    }

    public static RegistreerVerenigingZonderEigenRechtspersoonlijkheid_WithAllFields Called(AdminApiFixture fixture)
        => called ??= new RegistreerVerenigingZonderEigenRechtspersoonlijkheid_WithAllFields(fixture);
...
public class With_All_Fields
{
    ...
    private RegistreerVerenigingZonderEigenRechtspersoonlijkheidRequest Request
        => RegistreerVerenigingZonderEigenRechtspersoonlijkheid_WithAllFields.Called(_fixture).Request;

    private HttpResponseMessage Response
        => RegistreerVerenigingZonderEigenRechtspersoonlijkheid_WithAllFields.Called(_fixture).Response;
    ...
    {
        var savedEvent = GetVerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerdEvent();
    ...
    private VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd? GetVerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerdEvent()
    {
        using var session = _fixture.DocumentStore
                                    .LightweightSession();
