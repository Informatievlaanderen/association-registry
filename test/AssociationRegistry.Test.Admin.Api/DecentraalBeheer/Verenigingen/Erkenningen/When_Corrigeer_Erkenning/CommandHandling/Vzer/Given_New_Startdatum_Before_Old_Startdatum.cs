...
public class Given_New_Startdatum_Before_Old_Startdatum
{
    ...
    private readonly VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerdWithErkenningInAanvraagScenario _scenario;
    ...
    public Given_New_Startdatum_Before_Old_Startdatum()
    {
        ...
        _scenario = new VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerdWithErkenningInAanvraagScenario();
