...
public class Given_A_Valid_Command
{
    ...
    private readonly VerenigingMetRechtspersoonlijkheidWerdGeregistreerdWithTeVerlopenErkenningScenario _scenario;
    ...
    public Given_A_Valid_Command()
    {
        ...
        _scenario = new VerenigingMetRechtspersoonlijkheidWerdGeregistreerdWithTeVerlopenErkenningScenario();
