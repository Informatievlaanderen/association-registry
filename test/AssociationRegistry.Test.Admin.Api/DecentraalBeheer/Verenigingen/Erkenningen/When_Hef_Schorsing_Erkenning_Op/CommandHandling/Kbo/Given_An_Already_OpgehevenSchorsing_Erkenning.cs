...
public class Given_An_Already_OpgehevenSchorsing_Erkenning
{
    ...
    private readonly VerenigingMetRechtspersoonlijkheidWerdGeregistreerdWithOpgehevenSchorsingErkenningScenario _scenario;
    private readonly AggregateSessionMock _verenigingRepositoryMock;

    public Given_An_Already_OpgehevenSchorsing_Erkenning()
    {
        _fixture = new Fixture().CustomizeAdminApi();

        _scenario = new VerenigingMetRechtspersoonlijkheidWerdGeregistreerdWithOpgehevenSchorsingErkenningScenario();
