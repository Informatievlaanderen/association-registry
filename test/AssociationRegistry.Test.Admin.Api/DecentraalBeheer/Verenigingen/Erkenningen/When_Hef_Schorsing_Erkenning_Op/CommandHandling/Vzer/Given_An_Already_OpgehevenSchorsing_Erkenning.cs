...
public class Given_An_Already_OpgehevenSchorsing_Erkenning
{
    ...
    private readonly VzerWerdGeregistreerdWithOpgehevenSchorsingErkenningScenario _scenario;
    ...
    public Given_An_Already_OpgehevenSchorsing_Erkenning()
    {
        ...
        _scenario = new VzerWerdGeregistreerdWithOpgehevenSchorsingErkenningScenario();
