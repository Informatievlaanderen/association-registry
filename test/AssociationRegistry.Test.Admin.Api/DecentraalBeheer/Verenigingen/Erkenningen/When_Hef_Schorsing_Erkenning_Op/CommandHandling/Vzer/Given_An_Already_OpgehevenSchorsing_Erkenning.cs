...
{
    private readonly HefSchorsingErkenningOpContext<VzerWerdGeregistreerdWithOpgehevenSchorsingErkenningScenario> _ctx =
        new(new VzerWerdGeregistreerdWithOpgehevenSchorsingErkenningScenario(),
