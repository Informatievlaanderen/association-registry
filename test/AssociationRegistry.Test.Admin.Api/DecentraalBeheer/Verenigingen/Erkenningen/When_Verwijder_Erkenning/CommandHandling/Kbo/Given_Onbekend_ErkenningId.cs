...
{
    private readonly VerwijderErkenningContext<VerenigingMetRechtspersoonlijkheidWerdGeregistreerdWithGeschorsteErkenningScenario> _ctx =
    ...
    {
        var onbekendErkenningId = _ctx.CreateUnknownErkenningId();
        var command = _ctx.CreateCommand(erkenningId: onbekendErkenningId);
