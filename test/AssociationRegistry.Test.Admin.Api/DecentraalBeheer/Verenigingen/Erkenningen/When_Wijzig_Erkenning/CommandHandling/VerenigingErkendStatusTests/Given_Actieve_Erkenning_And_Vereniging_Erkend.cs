...
public class Given_Actieve_Erkenning_And_Vereniging_Erkend
{
    ...
    public async ValueTask With_Wijzig_Actieve_Erkenning_Then_Saves_ErkenningWerdGewijzigd(
    ...
    [Theory]
    [MemberData(nameof(ErkenningScenarios))]
    public async ValueTask With_Wijzig_Niet_Actieve_Erkenning_Then_Saves_ErkenningWerdGewijzigd_And_VerenigingNietLangerErkend(
        CommandhandlerScenarioBase scenario,
        int erkenningId
    )
    {
