...
public class Given_NietActieve_Erkenning
{
    ...
    public async ValueTask With_Wijzig_Actieve_Erkenning_Then_Saves_ErkenningWerdGewijzigd_And_VerenigingWerdErkend(
    ...
    [Theory]
    [MemberData(nameof(ErkenningScenarios))]
    public async ValueTask With_Wijzig_Niet_Actieve_Erkenning_Then_Saves_ErkenningWerdGewijzigd_And_VerenigingWerdErkend(
        CommandhandlerScenarioBase scenario,
        int erkenningId
    )
    {
