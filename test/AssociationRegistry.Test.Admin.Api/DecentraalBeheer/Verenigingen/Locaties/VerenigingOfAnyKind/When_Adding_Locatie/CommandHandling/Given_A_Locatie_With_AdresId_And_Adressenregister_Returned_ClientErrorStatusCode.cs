...
public class Given_A_Locatie_With_AdresId_And_Adressenregister_Returned_ClientErrorStatusCode
{
    ...
    public async ValueTask Then_Throws_AdressenregisterReturnedClientErrorStatusCode(
    ...
    )
    {
        ...
        var exception = await Assert.ThrowsAsync<AdressenregisterReturnedClientErrorStatusCode>(async () =>
