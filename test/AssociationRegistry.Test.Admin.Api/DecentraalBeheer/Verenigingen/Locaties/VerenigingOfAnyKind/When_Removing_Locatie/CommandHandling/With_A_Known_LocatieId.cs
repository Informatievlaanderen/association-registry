...
public class With_A_Known_LocatieId
{
    ...
    public With_A_Known_LocatieId()
    {
        ...
        var commandHandler = new VerwijderLocatieCommandHandler(_aggregateSessionMock, geotagsService.Object);

        commandHandler
            .Handle(new CommandEnvelope<VerwijderLocatieCommand>(command, commandMetadata))
            .GetAwaiter()
            .GetResult();
    }
    ...
    {
        _aggregateSessionMock.ShouldHaveLoaded<VerenigingOfAnyKind>(_scenario.VCode);
    }
    ...
    public void Then_A_VertegenwoordigerWerdVerwijderd_Event_Is_Saved()
    {
        _aggregateSessionMock.ShouldHaveSavedExact(
            new LocatieWerdVerwijderd(_scenario.VCode, _scenario.LocatieWerdToegevoegd.Locatie),
