...
{
    public RegistreerVzwRegistreerSetup(EventsInDbScenariosFixture fixture)
        : base(fixture, kboNummer: "0554790609") { }
}

public class With_KboNummer_For_Vzw
    : With_KboNummer_For_Supported_Vereniging,
        IClassFixture<RegistreerVzwRegistreerSetup>
{
    public With_KboNummer_For_Vzw(EventsInDbScenariosFixture fixture, RegistreerVzwRegistreerSetup registreerSetup)
