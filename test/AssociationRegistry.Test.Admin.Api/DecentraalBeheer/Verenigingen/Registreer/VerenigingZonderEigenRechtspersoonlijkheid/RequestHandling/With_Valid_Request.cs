...
public class With_Valid_Request
{
    ...
    public With_Valid_Request()
    {
        ...
        _controller = new RegistreerVerenigingZonderEigenRechtspersoonlijkheidController(
            ...
            validator: new RegistreerVerenigingZonderEigenRechtspersoonlijkheidRequestValidator(clock: new Clock()),
    ...
    public async ValueTask Then_it_returns_an_acceptedResponse()
    {
        var response = await _controller.Post(
            request: _fixture.Create<RegistreerVerenigingZonderEigenRechtspersoonlijkheidRequest>(),
