...
public class With_Duplicate : IClassFixture<With_Duplicate.Setup>
{
                    ...
                    [
                        new Registratiedata.Locatie(
                            ...
                            new Registratiedata.Adres(
                                _setup.RequestLocatie.Adres!.Straatnaam,
            ...
            var dubbeleVerenigingenWerdenGedetecteerd = new DubbeleVerenigingenWerdenGedetecteerd(
                ...
                GedetecteerdeDubbels: new Registratiedata.DuplicateVereniging[]
                {
                    new Registratiedata.DuplicateVereniging(
                        potentieleDubbel.VCode,
                        new Registratiedata.Verenigingstype(Verenigingstype.VZER.Code, Verenigingstype.VZER.Naam),
                        new Registratiedata.Verenigingssubtype(
                            VerenigingssubtypeCode.Default.Code,
                        ...
                        potentieleDubbel
                            .HoofdactiviteitenVerenigingsloket.Select(
                                x => new Registratiedata.HoofdactiviteitVerenigingsloket(x.Code, x.Naam)
                            )
                            .ToArray(),
                        potentieleDubbel
                            .Locaties.Select(x => new Registratiedata.DuplicateVerenigingLocatie(
                                x.Locatietype,
                                x.IsPrimair,
                                x.Adres.ToAdresString(),
                                x.Naam,
                                x.Adres.Postcode,
                                x.Adres.Gemeente
                            ))
    ...
    public sealed class Setup
    {
        ...
        public Setup(EventsInDbScenariosFixture fixture)
        {
            ...
            Response = fixture
                .DefaultClient.RegistreerVerenigingZonderEigenRechtspersoonlijkheid(requestAsJson)
                .GetAwaiter()
                .GetResult();
        }
