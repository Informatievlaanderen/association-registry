...
public sealed class RegistreerVerenigingZonderEigenRechtspersoonlijkheid_With_Same_Naam_And_Postcode
{
    ...
    private RegistreerVerenigingZonderEigenRechtspersoonlijkheid_With_Same_Naam_And_Postcode(
    ...
    )
    {
        ...
        Response = fixture
            .DefaultClient.RegistreerVerenigingZonderEigenRechtspersoonlijkheid(
                content: JsonConvert.SerializeObject(value: Request)
            )
            .GetAwaiter()
            .GetResult();
    }

    public static RegistreerVerenigingZonderEigenRechtspersoonlijkheid_With_Same_Naam_And_Postcode Called(
        EventsInDbScenariosFixture fixture
    ) =>
        called ??= new RegistreerVerenigingZonderEigenRechtspersoonlijkheid_With_Same_Naam_And_Postcode(
            fixture: fixture
        );
}
...
public class With_Same_Naam_And_Postcode
{
    ...
    private RegistreerVerenigingZonderEigenRechtspersoonlijkheidRequest Request =>
        RegistreerVerenigingZonderEigenRechtspersoonlijkheid_With_Same_Naam_And_Postcode
    ...
    private string Naam =>
        RegistreerVerenigingZonderEigenRechtspersoonlijkheid_With_Same_Naam_And_Postcode.Called(fixture: _fixture).Naam;
