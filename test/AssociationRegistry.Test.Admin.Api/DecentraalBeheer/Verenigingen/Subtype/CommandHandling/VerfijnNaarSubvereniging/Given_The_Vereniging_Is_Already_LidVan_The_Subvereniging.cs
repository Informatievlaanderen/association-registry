...
public class Given_The_Vereniging_Is_Already_LidVan_The_Subvereniging
{
    ...
    public async ValueTask For_Verfijnen_Naar_Subvereniging()
    {
        ...
        var scenario =
            new VerenigingKanGeenSubverenigingWordenWaarvanHijAlReedsLidIsScenario.VoorTeVerfijenSubverenigingScenario();
        var rechtspersoonScenario =
            new VerenigingKanGeenSubverenigingWordenWaarvanHijAlReedsLidIsScenario.VerenigingMetRechtspersoonlijkheidWerdGeregistreerdScenario();

        var verenigingRepositoryMock = new MultipleVerenigingAggregateSessionMock(scenario.GetVerenigingState());
        ...
        var exception = await Assert.ThrowsAnyAsync<VerenigingKanGeenSubverenigingWordenWaarvanZijAlReedsLidIs>(() =>
    ...
    public async ValueTask For_Wijzig_Subvereniging()
    {
        var fixture = new Fixture().CustomizeDomain();
        var scenario =
            new VerenigingKanGeenSubverenigingWordenWaarvanHijAlReedsLidIsScenario.VoorTeWijzigenSubverenigingScenario();
        var rechtspersoonScenario =
            new VerenigingKanGeenSubverenigingWordenWaarvanHijAlReedsLidIsScenario.VerenigingMetRechtspersoonlijkheidWerdGeregistreerdScenario();
