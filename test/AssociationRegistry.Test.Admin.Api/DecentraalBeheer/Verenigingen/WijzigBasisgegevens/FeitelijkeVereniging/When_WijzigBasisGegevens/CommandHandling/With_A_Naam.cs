...
public class With_A_Naam
{
    ...
    public With_A_Naam()
    {
        ...
        var command = new WijzigBasisgegevensCommand(_scenario.VCode, VerenigingsNaam.Create(NieuweNaam));
    ...
    {
        _aggregateSessionMock.ShouldHaveSavedExact(new NaamWerdGewijzigd(_scenario.VCode, NieuweNaam));
    }
}
