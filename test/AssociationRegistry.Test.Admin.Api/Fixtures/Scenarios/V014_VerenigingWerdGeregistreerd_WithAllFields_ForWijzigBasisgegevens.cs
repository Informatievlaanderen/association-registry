...
public class V014_VerenigingWerdGeregistreerd_WithAllFields_ForWijzigBasisgegevens : IEventsInDbScenario
{
    public readonly FeitelijkeVerenigingWerdGeregistreerd FeitelijkeVerenigingWerdGeregistreerd;
    public readonly CommandMetadata Metadata;

    public V014_VerenigingWerdGeregistreerd_WithAllFields_ForWijzigBasisgegevens()
    {
