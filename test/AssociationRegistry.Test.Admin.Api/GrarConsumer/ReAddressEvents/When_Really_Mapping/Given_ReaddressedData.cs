namespace AssociationRegistry.Test.Admin.Api.GrarConsumer.ReAddressEvents.When_Really_Mapping;

using AssociationRegistry.Admin.Api.GrarConsumer.Kafka.StraatHernummering;
using AutoFixture;
