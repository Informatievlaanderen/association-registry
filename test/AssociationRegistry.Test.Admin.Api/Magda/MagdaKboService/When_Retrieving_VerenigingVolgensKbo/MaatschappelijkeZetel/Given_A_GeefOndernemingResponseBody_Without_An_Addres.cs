namespace AssociationRegistry.Test.Admin.Api.Magda.MagdaKboService.When_Retrieving_VerenigingVolgensKbo.MaatschappelijkeZetel;
...
public class Given_A_GeefOndernemingResponseBody_Without_An_Addres
{
    ...
    public Given_A_GeefOndernemingResponseBody_Without_An_Addres()
    {
    ...
    [Fact]
    public async Task Then_It_Returns_A_Null_Adress()
    {
