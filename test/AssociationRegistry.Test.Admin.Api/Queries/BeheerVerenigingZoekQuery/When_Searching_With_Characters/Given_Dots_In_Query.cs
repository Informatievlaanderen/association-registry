...
public class Given_Dots_In_Query_Fixture : ElasticRepositoryFixture
{
    public Given_Dots_In_Query_Fixture() : base(nameof(Given_Dots_In_Query_Fixture))
    {

    }
}

public class Given_Dots_In_Query: IClassFixture<Given_Dots_In_Query_Fixture>, IDisposable, IAsyncDisposable
{
    private readonly Given_Dots_In_Query_Fixture _fixture;
    private readonly ITestOutputHelper _helper;
    private readonly ElasticsearchClient? _elasticClient;
    private readonly Fixture _autoFixture;
    private readonly BeheerVerenigingenZoekQuery _query;

    public Given_Dots_In_Query(Given_Dots_In_Query_Fixture fixture, ITestOutputHelper helper)
    {
        _fixture = fixture;
        _helper = helper;
