...
{
    public With_KboNummer_For_Ivzw(EventsInDbScenariosFixture fixture, RegistreerIVzwSetup registreerVereniginMetRechtspersoonlijkheidSetup)
        : base(fixture, registreerVereniginMetRechtspersoonlijkheidSetup)
    {
    }
