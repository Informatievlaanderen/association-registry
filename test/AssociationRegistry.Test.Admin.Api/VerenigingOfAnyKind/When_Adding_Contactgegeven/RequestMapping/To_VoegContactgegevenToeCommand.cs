namespace AssociationRegistry.Test.Admin.Api.VerenigingOfAnyKind.When_Adding_Contactgegeven.RequestMapping;
...
public class To_VoegContactgegevenToeCommand
{
    ...
    public void Then_We_Get_A_Correct_Command()
    {
        ...
        command.Contactgegeven.Contactgegeventype.Should().Be(Contactgegeventype.Parse(request.Contactgegeven.Type));
