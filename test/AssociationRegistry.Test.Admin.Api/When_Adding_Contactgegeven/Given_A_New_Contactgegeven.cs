...
public class Post_A_New_Contactgegeven : IAsyncLifetime
{
    ...
    public VerenigingWerdGeregistreerd_WithAllFields_EventsInDbScenario Scenario { get; }
    ...
    public Post_A_New_Contactgegeven(EventsInDbScenariosFixture fixture)
    {
        ...
        Scenario = fixture.VerenigingWerdGeregistreerdWithAllFieldsEventsInDbScenario;
