namespace AssociationRegistry.Test.Admin.Api.When_RegistreerFeitelijkeVereniging.RequestValidating.A_KboNumber;
...
//         var result = validator.TestValidate(new RegistreerFeitelijkeVerenigingRequest { KboNummer = "1234" });
//
