    ...
    public void Then_it_creates_a_new_document()
    {
        _document.Should().BeEquivalentTo(
            new BeheerVerenigingHistoriekDocument
            {
                ...
                {
                    new(
                        $"Vereniging werd geregistreerd met naam '{_verenigingWerdGeregistreerd.Data.Naam}' door {_verenigingWerdGeregistreerd.Initiator} op datum {_verenigingWerdGeregistreerd.Tijdstip.ToBelgianDateAndTime()}.",
