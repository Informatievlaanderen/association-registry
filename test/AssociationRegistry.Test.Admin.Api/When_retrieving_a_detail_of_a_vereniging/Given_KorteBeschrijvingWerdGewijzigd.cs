...
public class When_Detail_Given_KorteBeschrijvingWerdGewijzigd_Fixture : AdminApiFixture
{
...
public class Given_KorteBeschrijvingWerdGewijzigd : IClassFixture<When_Detail_Given_KorteBeschrijvingWerdGewijzigd_Fixture>
{
    private readonly When_Detail_Given_KorteBeschrijvingWerdGewijzigd_Fixture _adminApiFixture;

    public Given_KorteBeschrijvingWerdGewijzigd(When_Detail_Given_KorteBeschrijvingWerdGewijzigd_Fixture adminApiFixture)
    {
    ...
    public async Task Then_we_get_a_detail_vereniging_response()
    {
        ...
        {{
            ""vereniging"": {{
                    ...
                    ""korteNaam"": ""{_adminApiFixture.VerenigingWerdGeregistreerd.KorteNaam}"",
                    ""korteBeschrijving"": ""{_adminApiFixture.KorteBeschrijvingWerdGewijzigd.KorteBeschrijving}"",
