...
public class When_Historiek_Given_KorteBeschrijvingWerdGewijzigd_Fixture : AdminApiFixture
{
    ...
    public When_Historiek_Given_KorteBeschrijvingWerdGewijzigd_Fixture() : base(nameof(When_Historiek_Given_KorteBeschrijvingWerdGewijzigd_Fixture))
    {
        ...
        _korteBeschrijvingWerdGewijzigd = _fixture.Create<KorteBeschrijvingWerdGewijzigd>() with { VCode = VCode };
    }
    ...
    protected override async Task Given()
    {
        ...
        await AddEvent(
            VCode,
            _korteBeschrijvingWerdGewijzigd,
            Metadata);
    }
...
public class Given_KorteBeschrijvingWerdGewijzigd : IClassFixture<When_Historiek_Given_KorteBeschrijvingWerdGewijzigd_Fixture>
{
    private readonly When_Historiek_Given_KorteBeschrijvingWerdGewijzigd_Fixture _fixture;

    public Given_KorteBeschrijvingWerdGewijzigd(When_Historiek_Given_KorteBeschrijvingWerdGewijzigd_Fixture fixture)
    {
        _fixture = fixture;
    }
