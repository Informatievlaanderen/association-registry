...
public static class EventCustomizations
{
    ...
    {
        fixture.Customize<LidmaatschapWerdToegevoegd>(composer =>
            composer
                .FromFactory(() =>
    ...
    {
        fixture.Customize<VertegenwoordigerWerdToegevoegdVanuitKBO>(composer =>
            composer
                .FromFactory(() =>
    ...
    {
        fixture.Customize<VerenigingMetRechtspersoonlijkheidWerdGeregistreerd>(composer =>
            composer
                .FromFactory<int>(i => new VerenigingMetRechtspersoonlijkheidWerdGeregistreerd(
    ...
    {
        fixture.Customize<ContactgegevenWerdToegevoegd>(composer =>
            composer
                .FromFactory(() =>
                {
    ...
    {
        fixture.Customize<ContactgegevenWerdOvergenomenUitKBO>(composer =>
            composer
                .FromFactory<int>(i =>
                {
    ...
    {
        fixture.Customize<VertegenwoordigerWerdOvergenomenUitKBO>(composer =>
            composer
                .FromFactory(() =>
    ...
    {
        fixture.Customize<VertegenwoordigerWerdGewijzigdInKBO>(composer =>
            composer
                .FromFactory(() =>
    ...
    {
        fixture.Customize<ContactgegevenKonNietOvergenomenWordenUitKBO>(composer =>
            composer
                .FromFactory(() =>
                {
    ...
    {
        fixture.Customize<VertegenwoordigerWerdToegevoegd>(composer =>
            composer
                .FromFactory(() =>
    ...
    {
        fixture.Customize<FeitelijkeVerenigingWerdGeregistreerd>(composer =>
            composer
                .FromFactory(() =>
    ...
    {
        fixture.Customize<VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd>(composer =>
            composer
                .FromFactory(() =>
                    new VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd(
                        ...
                        fixture.Create<Registratiedata.Doelgroep>(),
                        IsUitgeschrevenUitPubliekeDatastroom: false,
                        fixture.CreateMany<Registratiedata.Contactgegeven>().OrderBy(x => x.ContactgegevenId).ToArray(),
                        fixture.CreateMany<Registratiedata.Locatie>().OrderBy(x => x.LocatieId).ToArray(),
                        fixture
    ...
    {
        fixture.Customize<RechtsvormWerdGewijzigdInKBO>(composer =>
            composer
                .FromFactory(() => new RechtsvormWerdGewijzigdInKBO(fixture.Create<Verenigingstype>().Code))
                .OmitAutoProperties()
        );
    }
    ...
    {
        fixture.Customize<WeigeringDubbelDoorAuthentiekeVerenigingWerdVerwerkt>(composer =>
            composer
                .FromFactory(() =>
    ...
    {
        fixture.Customize<VerenigingAanvaarddeDubbeleVereniging>(composer =>
            composer
                .FromFactory(() =>
    ...
    {
        fixture.Customize<BankrekeningnummerWerdToegevoegd>(composer =>
            composer
                .FromFactory(() =>
    ...
    private static void CustomizeBankrekeningnummerWerdToegevoegdVanuitKBO(this IFixture fixture)
    {
        fixture.Customize<BankrekeningnummerWerdToegevoegdVanuitKBO>(composer =>
            composer
                .FromFactory(() =>
                    new BankrekeningnummerWerdToegevoegdVanuitKBO(
                        fixture.Create<int>(),
                        fixture.Create<IbanNummer>().Value
                    )
                )
