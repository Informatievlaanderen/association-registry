    ...
    VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerdWithErkenningenScenario : CommandhandlerScenarioBase
{
    ...
    public override IEnumerable<IEvent> Events() =>
        new IEvent[]
        {
            VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd, ErkenningWerdGeregistreerdInVerleden,
            ErkenningWerdGeregistreerdInHuidig, ErkenningWerdGeregistreerdInToekomst,
