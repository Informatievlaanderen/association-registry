namespace AssociationRegistry.Test.E2E.Erkenningen.When_Verwijder_Erkenning.Beheer.Historiek;
...
public class Returns_Historiek_Met_Erkenning : End2EndTest<HistoriekResponse>
{
    ...
    public Returns_Historiek_Met_Erkenning(VerwijderErkenningContext testContext)
    ...
    public void With_ErkenningWerdGerigistreerd_Gebeurtenissen()
    {
        var gebeurtenisResponse = Response.Gebeurtenissen.SingleOrDefault(x =>
            x.Gebeurtenis == nameof(ErkenningWerdVerwijderd)
        );

        gebeurtenisResponse.ShouldCompare(
            HistoriekGebeurtenisMapper.ErkenningWerdVerwijderd(
