...
public class BankrekeningnummerWerdVerwijderdUitKBOScenario : IScenario
{
    ...
    public BankrekeningnummerWerdVerwijderdUitKBO BankrekeningnummerWerdVerwijderdUitKBO { get; set; }
    ...
    public async Task<KeyValuePair<string, IEvent[]>[]> GivenEvents(IVCodeService service)
    {
        ...
        BankrekeningnummerWerdVerwijderdUitKBO = fixture.Create<BankrekeningnummerWerdVerwijderdUitKBO>() with
        {
        ...
        return
        [
            new(VerenigingMetRechtspersoonlijkheidWerdGeregistreerd.VCode, [VerenigingMetRechtspersoonlijkheidWerdGeregistreerd, BankrekeningnummerWerdToegevoegdVanuitKBO, BankrekeningnummerWerdVerwijderdUitKBO]),
        ];
    }
