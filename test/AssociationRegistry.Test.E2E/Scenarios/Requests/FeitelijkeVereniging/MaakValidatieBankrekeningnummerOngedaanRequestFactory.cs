...
public class MaakValidatieBankrekeningnummerOngedaanRequestFactory : ITestRequestFactory<NullRequest>
{
    ...
    public async Task<CommandResult<NullRequest>> ExecuteRequest(IApiSetup apiSetup)
    {
        ...
        {
            s.Delete.Url($"/v1/verenigingen/{_scenario.VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd.VCode}/bankrekeningnummers/{_scenario.AanwezigheidBankrekeningnummerValidatieDocumentWerdBevestigd.BankrekeningnummerId}/validaties");
