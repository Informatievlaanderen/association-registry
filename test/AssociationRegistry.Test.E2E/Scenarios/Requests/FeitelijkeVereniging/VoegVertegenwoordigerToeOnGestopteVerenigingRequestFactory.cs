...
public class VoegVertegenwoordigerToeOnGestopteVerenigingRequestFactory : ITestRequestFactory<VoegVertegenwoordigerToeRequest>
{
    private readonly string _isPositiveInteger = "^[1-9][0-9]*$";

    private readonly VerenigingZonderEigenRechtspersoonlijkheidWerdGestoptScenario _scenario;

    public VoegVertegenwoordigerToeOnGestopteVerenigingRequestFactory(VerenigingZonderEigenRechtspersoonlijkheidWerdGestoptScenario scenario)
    {
        _scenario = scenario;
    }
