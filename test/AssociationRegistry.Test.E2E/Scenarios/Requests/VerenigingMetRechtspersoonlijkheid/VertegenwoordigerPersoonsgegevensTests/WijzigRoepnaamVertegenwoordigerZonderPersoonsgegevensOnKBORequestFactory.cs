...
public class WijzigRoepnaamVertegenwoordigerZonderPersoonsgegevensOnKBORequestFactory : ITestRequestFactory<WijzigBasisgegevensRequest>
{
    private readonly string _isPositiveInteger = "^[1-9][0-9]*$";

    private readonly VertegenwoordigerZonderPersoonsgegevensOnKBOScenario _scenario;

    public WijzigRoepnaamVertegenwoordigerZonderPersoonsgegevensOnKBORequestFactory(VertegenwoordigerZonderPersoonsgegevensOnKBOScenario scenario)
    {
        _scenario = scenario;
    }
