namespace AssociationRegistry.Test.E2E.V2.When_Registreer_VerenigingMetRechtspersoonlijkheid.Beheer_Historiek;
...
public class Returns_Historiek : End2EndTest<RegistreerVerenigingMetRechtspersoonlijkheidTestContext, RegistreerVerenigingUitKboRequest, HistoriekResponse>
{
    ...
    public Returns_Historiek(RegistreerVerenigingMetRechtspersoonlijkheidTestContext testContext) : base(testContext)
    {
    }
