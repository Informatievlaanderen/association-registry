namespace AssociationRegistry.Test.E2E.V2.When_Registreer_VerenigingMetRechtspersoonlijkheid.Publiek_Detail;
...
public class Returns_DetailResponse : End2EndTest<RegistreerVerenigingMetRechtspersoonlijkheidTestContext, RegistreerVerenigingUitKboRequest, PubliekVerenigingDetailResponse>
{
    private readonly RegistreerVerenigingMetRechtspersoonlijkheidTestContext _testContext;

    public Returns_DetailResponse(RegistreerVerenigingMetRechtspersoonlijkheidTestContext testContext) : base(testContext)
    {
