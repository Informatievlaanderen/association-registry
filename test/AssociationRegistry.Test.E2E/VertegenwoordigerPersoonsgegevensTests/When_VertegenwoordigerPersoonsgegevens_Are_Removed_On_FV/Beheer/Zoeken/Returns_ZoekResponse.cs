namespace AssociationRegistry.Test.E2E.VertegenwoordigerPersoonsgegevensTests.When_VertegenwoordigerPersoonsgegevens_Are_Removed_On_FV.Beheer.Zoeken;
    ...
    : End2EndTest<SearchVerenigingenResponse>
{
    ...
    public Returns_SearchVerenigingenResponse(VertegenwoordigerZonderPersoonsgegevensOnFVScenarioTestContext testContext, ITestOutputHelper testOutputHelper) : base(testContext.ApiSetup)
    {
