namespace AssociationRegistry.Test.E2E.VertegenwoordigerPersoonsgegevensTests.When_VertegenwoordigerPersoonsgegevens_Are_Removed_On_VZER.Beheer.Zoeken;
    ...
    : End2EndTest<SearchVerenigingenResponse>
{
    ...
    public Returns_SearchVerenigingenResponse(VertegenwoordigerZonderPersoonsgegevensOnVZERScenarioTestContext testContext, ITestOutputHelper testOutputHelper) : base(testContext.ApiSetup)
    {
