namespace AssociationRegistry.Test.E2E.VertegenwoordigerPersoonsgegevensTests.When_Wijzig_Naam_On_Vzer.Beheer.Detail;
...
public class Returns_Gewijzigde_Naam : End2EndTest<DetailVerenigingResponse>
{
    ...
    public Returns_Gewijzigde_Naam(WijzigNaamOnVZERTestContext testContext) : base(testContext.ApiSetup)
    {
