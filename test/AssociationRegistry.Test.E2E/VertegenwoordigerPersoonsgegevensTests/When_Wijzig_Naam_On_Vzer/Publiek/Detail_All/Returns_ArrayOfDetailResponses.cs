namespace AssociationRegistry.Test.E2E.VertegenwoordigerPersoonsgegevensTests.When_Wijzig_Naam_On_Vzer.Publiek.Detail_All;
    ...
    : End2EndTest<PubliekVerenigingDetailResponse>
{
    ...
    public Returns_ArrayOfDetailResponses(WijzigNaamOnVZERTestContext testContext) : base(testContext.ApiSetup)
    {
