namespace AssociationRegistry.Test.E2E.When_Neem_Vertegenwoordiger_Uit_KBO.Beheer.Historiek;
...
public class Returns_Detail_With_Vertegenwoordiger : End2EndTest<HistoriekResponse>
{
    ...
    public Returns_Detail_With_Vertegenwoordiger(NeemVertegenwoordigerOverUitKBOContext testContext) : base(testContext.ApiSetup)
    {
    ...
    {
        var gebeurtenisResponse = Response.Gebeurtenissen.SingleOrDefault(x => x.Gebeurtenis == nameof(VertegenwoordigerWerdOvergenomenUitKBO));
        gebeurtenisResponse.ShouldCompare(HistoriekGebeurtenisMapper.VertegenwoordigerWerdOvergenomenUitKBO(_testContext.Scenario.VertegenwoordigerWerdOvergenomenUitKBO),
