namespace AssociationRegistry.Test.E2E.When_Registreer_VerenigingMetRechtspersoonlijkheid.Publiek.Zoeken.With_Header;
...
public class Returns_Vereniging : End2EndTest<SearchVerenigingenResponse>
{
    ...
    public override async Task<SearchVerenigingenResponse> GetResponse(FullBlownApiSetup setup)
        => await setup.PublicApiHost.GetPubliekZoekenWithHeader(setup.SuperAdminHttpClient,$"vCode:{_testContext.CommandResult.VCode}", _testContext.CommandResult.Sequence);
