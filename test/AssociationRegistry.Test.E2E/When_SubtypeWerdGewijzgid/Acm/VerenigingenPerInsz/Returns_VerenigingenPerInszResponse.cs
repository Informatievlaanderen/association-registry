namespace AssociationRegistry.Test.E2E.When_SubtypeWerdGewijzgid.Acm.VerenigingenPerInsz;
...
public class Returns_VerenigingenPerInszResponse :
    End2EndTest<WhenSubtypeWerdGewijzigdContext, WijzigSubtypeRequest, VerenigingenPerInszResponse>
{
    private readonly string _inszToCompare;
    private readonly VerenigingenPerInszRequest _request;

    public Returns_VerenigingenPerInszResponse(WhenSubtypeWerdGewijzigdContext testContext) : base(testContext)
    {
        _inszToCompare = TestContext.Scenario.BaseScenario.VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd.Vertegenwoordigers[0].Insz;
        ...
        Response.ShouldCompare(new VerenigingenPerInszResponse()
        {
            ...
            [
                new VerenigingenPerInszResponse.Vereniging()
                {
                    ...
                    VertegenwoordigerId = TestContext.Scenario.BaseScenario.VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd.Vertegenwoordigers[0].VertegenwoordigerId,
                    Naam = TestContext.Scenario.BaseScenario.VerenigingZonderEigenRechtspersoonlijkheidWerdGeregistreerd.Naam,
