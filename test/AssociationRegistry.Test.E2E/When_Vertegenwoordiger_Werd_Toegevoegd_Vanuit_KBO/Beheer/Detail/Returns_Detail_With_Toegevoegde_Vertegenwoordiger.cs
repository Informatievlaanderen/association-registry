namespace AssociationRegistry.Test.E2E.When_Vertegenwoordiger_Werd_Toegevoegd_Vanuit_KBO.Beheer.Detail;
...
[Collection(nameof(VertegenwoordigerWerdToegevoegdVanuitKBOCollection))]
public class Returns_Detail_With_Toegevoegde_Vertegenwoordiger : End2EndTest<DetailVerenigingResponse>
{
    private readonly VertegenwoordigerWerdToegevoegdVanuitKBOContext _testContext;

    public Returns_Detail_With_Toegevoegde_Vertegenwoordiger(VertegenwoordigerWerdToegevoegdVanuitKBOContext testContext)
