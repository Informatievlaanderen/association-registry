namespace AssociationRegistry.Test.E2E.When_Verwijder_Vertegenwoordiger_Uit_KBO.Beheer.Bewaartermijn;
...
public class Returns_Bewaartermijn_For_Removed_Vertegenwoordiger : End2EndTest<BewaartermijnResponse>
{
    ...
    public Returns_Bewaartermijn_For_Removed_Vertegenwoordiger(VerwijderVertegenwoordigerUitKBOContext testContext)
    ...
    public override async Task<BewaartermijnResponse> GetResponse(FullBlownApiSetup setup) =>
        await setup.AdminApiHost.GetBewaartermijn(
            ...
            _testContext.VCode,
            _testContext.Scenario.VertegenwoordigerWerdVerwijderdUitKBO.VertegenwoordigerId,
    ...
    {
        var expectedId =
            $"{BewaartermijnId.BewaartermijnAggregateName}-{_testContext.VCode}-{PersoonsgegevensType.Vertegenwoordigers.Value}-{_testContext.Scenario.VertegenwoordigerWerdVerwijderdUitKBO.VertegenwoordigerId}";
        ...
        Response
            ...
            .BeEquivalentTo(
                new
                {
                    ...
                    EntityId = _testContext.Scenario.VertegenwoordigerWerdVerwijderdUitKBO.VertegenwoordigerId,
                    Reden = BewaartermijnReden.VertegenwoordigerWerdVerwijderdUitKbo,
