...
public class Returns_SearchVerenigingenResponse : End2EndTest<SearchVerenigingenResponse>
{
    ...
    public async ValueTask WithFeitelijkeVereniging()
        ...
        => Response.Verenigingen.Single().ShouldCompare(new Vereniging()
        {
            ...
            HoofdactiviteitenVerenigingsloket = PubliekZoekResponseMapper.MapHoofdactiviteitenVerenigingsloket(_testContext.Scenario.FeitelijkeVerenigingWerdGeregistreerd.HoofdactiviteitenVerenigingsloket),
            Werkingsgebieden = [],
    ...
    public override async Task<SearchVerenigingenResponse> GetResponse(FullBlownApiSetup setup)
        => await _testContext.ApiSetup.PublicApiHost.GetPubliekZoeken($"vCode:{_testContext.VCode}", _testContext.CommandResult.Sequence);
}
