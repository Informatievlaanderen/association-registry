    ...
    public void JsonContentMatches()
    {
        Response.Vereniging.Bankrekeningnummers.Should().BeEquivalentTo([
            new Bankrekeningnummer()
            {
                ...
                id = JsonLdType.Bankrekeningnummer.CreateWithIdValues(_testContext.VCode, _testContext.Scenario.BankrekeningnummerWerdToegevoegd.BankrekeningnummerId.ToString()),
