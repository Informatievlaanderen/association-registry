...
public class Given_ErkenningWerdGeactiveerd(BeheerDetailScenarioFixture<ErkenningWerdGeactiveerdScenario> fixture)
    : BeheerDetailScenarioClassFixture<ErkenningWerdGeactiveerdScenario>
{
    [Fact]
    public void Metadata_Is_Updated() => fixture.Result.Metadata.Version.Should().Be(3);

    [Fact]
    public void Then_Status_Is_Actief()
    {
