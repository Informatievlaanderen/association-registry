...
public class Given_SchorsingVanErkenningWerdOpgeheven(
    BeheerDetailScenarioFixture<SchorsingVanErkenningWerdOpgehevenScenario> fixture
) : BeheerDetailScenarioClassFixture<SchorsingVanErkenningWerdOpgehevenScenario>
{
    [Fact]
