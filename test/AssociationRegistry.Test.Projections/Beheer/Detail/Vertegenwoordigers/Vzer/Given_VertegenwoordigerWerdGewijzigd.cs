...
public class Given_VertegenwoordigerWerdGewijzigd(
    BeheerDetailScenarioFixture<VertegenwoordigerWerdGewijzigdScenario> fixture)
    : BeheerDetailScenarioClassFixture<VertegenwoordigerWerdGewijzigdScenario>
{
    [Fact]
    ...
    public void Vertegenwoordiger_Is_Toegevoegd()
    {
        ...
        {
            fixture.Scenario.VertegenwoordigerWerdGewijzigd.Roepnaam,
