...
public class Given_AdresKonNietOvergenomenWordenUitAdressenregister_MetRedenKonNietGevalideerdWorden(
    LocatiesZonderAdresMatchScenarioFixture<AdresKonNietOvergenomenWordenUitAdressenregisterRedenKonNietGevalideerdWordenScenario> fixture
)
    : LocatiesZonderAdresMatchScenarioClassFixture<AdresKonNietOvergenomenWordenUitAdressenregisterRedenKonNietGevalideerdWordenScenario>
{
    [Fact]
