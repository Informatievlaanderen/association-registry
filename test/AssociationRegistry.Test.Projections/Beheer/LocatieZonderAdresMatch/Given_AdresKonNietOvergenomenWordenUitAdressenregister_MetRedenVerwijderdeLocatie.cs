...
public class Given_AdresKonNietOvergenomenWordenUitAdressenregister_MetRedenVerwijderdeLocatie(
    LocatiesZonderAdresMatchScenarioFixture<AdresKonNietOvergenomenWordenUitAdressenregisterRedenLocatieVerwijderdScenario> fixture
)
    : LocatiesZonderAdresMatchScenarioClassFixture<AdresKonNietOvergenomenWordenUitAdressenregisterRedenLocatieVerwijderdScenario>
{
    [Fact]
