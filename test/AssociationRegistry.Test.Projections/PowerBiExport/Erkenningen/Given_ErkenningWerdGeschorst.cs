...
public class Given_ErkenningWerdGeschorst(PowerBiScenarioFixture<ErkenningWerdGeschorstScenario> fixture)
    : PowerBiScenarioClassFixture<ErkenningWerdGeschorstScenario>
{
    [Fact]
