...
public class Given_ValidatieBankrekeningWerdOngedaanGemaakt(PowerBiScenarioFixture<ValidatieBankrekeningnummerWerdOngedaanGemaaktScenario> fixture)
    : PowerBiScenarioClassFixture<ValidatieBankrekeningnummerWerdOngedaanGemaaktScenario>
{
    [Fact]
    ...
    public void ARecordIsStored_With_Historiek()
    {
        ...
        fixture.Result.Historiek.Should()
                             .ContainSingle(x => x.EventType == nameof(AanwezigheidBankrekeningnummerValidatieDocumentWerdOngedaanGemaakt));
    }
}
