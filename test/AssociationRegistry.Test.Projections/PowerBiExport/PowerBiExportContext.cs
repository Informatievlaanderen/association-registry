...
public class PowerBiExportContext : IProjectionContext, IAsyncLifetime
{
    private readonly string? _dbName = "powerbiexportprojections";
    ...
    public async Task InitializeAsync()
    {
        ...
        ProjectionHost = await AlbaHost.For<Program>(ConfigureForTesting(configuration, _dbName));
    ...
    {
        await WaitForNonStaleProjectionDataAsync();
    }

    private async Task WaitForNonStaleProjectionDataAsync()
