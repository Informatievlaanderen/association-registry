...
public class Given_one_vereniging_naam_werd_gewijzigd : IClassFixture<Given_one_vereniging_naam_werd_gewijzigd_fixture>
{
    ...
    public async Task Then_we_get_a_successful_response()
        => (await _publicApiClient.Search(Given_one_vereniging_naam_werd_gewijzigd_fixture.Naam)).Should().BeSuccessful();

    [Fact]
    public async Task? Then_we_retrieve_one_vereniging_matching_the_name_searched()
    {
        var response = await _publicApiClient.Search(Given_one_vereniging_naam_werd_gewijzigd_fixture.Naam);
