...
{
    [Fact]
    public async ValueTask Then_Keep_Previous_NutsLauInfo()
    {
        ...
        Mock<INutsLauFromGrarFetcher> nutsLauFromGrarFetcher)
    {
        ...
        nutsLauFromGrarFetcher.Setup(x => x.GetFlemishAndBrusselsNutsAndLauByPostcode(It.IsAny<CancellationToken>()))
