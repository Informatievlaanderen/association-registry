...
public class With_InactiveAddressFromGrar
{
    ...
    public async ValueTask Then_An_AdresWerdOntkoppeldVanAdressenregister_Was_Saved()
    {
        ...
        {
            LocatiesWithAdres = new List<LocatieWithAdres> { new(locatie.LocatieId, inactiefAdres) },
            VCode = "V001",
        ...
        grarClientMock.Setup(x => x.GetAddressById("123", CancellationToken.None)).ReturnsAsync(inactiefAdres);
