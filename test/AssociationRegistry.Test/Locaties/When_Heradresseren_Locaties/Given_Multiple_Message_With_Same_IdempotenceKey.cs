...
public class Given_Multiple_Message_With_Same_IdempotenceKey
{
    ...
    public async ValueTask Then_A_LocatieWerdToegevoegd_Event_Is_Saved()
    {
        ...
        grarClientMock.Setup(x => x.GetAddressById("123", CancellationToken.None)).ReturnsAsync(mockedAdresDetail1);

        grarClientMock.Setup(x => x.GetAddressById("456", CancellationToken.None)).ReturnsAsync(mockedAdresDetail2);
        ...
        var message1 = fixture.Create<HeradresseerLocatiesMessage>() with
        {
            ...
            {
                new(locatieId1, NaarAdresId: "123"),
                new(locatieId2, NaarAdresId: "456"),
            },
        ...
        var message2 = fixture.Create<HeradresseerLocatiesMessage>() with
        {
            TeHeradresserenLocaties = new List<TeHeradresserenLocatie>
            {
                new(locatieId1, NaarAdresId: "456"),
                new(locatieId2, NaarAdresId: "123"),
            },
            VCode = scenario.VCode,
