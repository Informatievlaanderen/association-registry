...
public class Given_Geen_Bankrekeningnummers
{
    private readonly MagdaGeefVerenigingService _service;
    private readonly Fixture _fixture;

    public Given_Geen_Bankrekeningnummers()
    {
        ...
        envelope.Body!.GeefOndernemingResponse!.Repliek.Antwoorden.Antwoord.Inhoud.Onderneming.Bankrekeningen = [];
    ...
    [Fact]
    public async ValueTask Then_It_Returns_Empty_Bankrekeningnummers()
    {
        ...
        using (new AssertionScope())
        {
            ...
            verenigingVolgensKbo.Bankrekeningnummers.Should().BeEmpty();
        }
    }
}
