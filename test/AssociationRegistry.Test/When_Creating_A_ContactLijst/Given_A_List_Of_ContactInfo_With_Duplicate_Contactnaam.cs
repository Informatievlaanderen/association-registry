...
public class Given_A_List_Of_ContactInfo_With_Duplicate_Contactnaam
{
    ...
    public void Then_It_Thows_A_DuplicateContactnaamException()
    {
        ...
        {
            ContactInfo.CreateInstance(contactnaam, "ip@adress.com", "255.255.255.0", "127.0.0.1", "#home", true),
            ContactInfo.CreateInstance(contactnaam, null, "255.255.255.128", "127.0.0.2", "#switch", false),
        };
